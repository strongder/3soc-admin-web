...
export function drawBoundingBoxes(
  ...
  boxes: Array<{ 
    ...
    label?: string; model?: string; score?: number; confidence?: number 
  }>,
  ...
  return new Promise((resolve, reject) => {
    ...
    img.onload = () => {
      ...
      boxes.forEach((box) => {
        ...
        const x2 = box.x2 ?? (box.x !== undefined && box.width !== undefined ? box.x + box.width : x1);
        const y2 = box.y2 ?? (box.y !== undefined && box.height !== undefined ? box.y + box.height : y1);
